...
export const LeftArrow = ({ count }) => {
  return (
    <svg
      className={
        count === 1
          ? "text-gray-300 w-6 h-6 cursor-pointer pointer-events-none"
          : `w-6 h-6 cursor-pointer pointer-events-none `
      }
...
export const RightArrow = () => {
  return (
    <svg
      className="w-6 h-6 cursor-pointer pointer-events-none"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
...
export const ShoppingCart = () => {
  return (
    <svg
      className="h-full w-full p-2 cursor-pointer"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
    >
      <path
